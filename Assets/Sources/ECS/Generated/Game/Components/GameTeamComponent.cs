...
public partial class GameEntity {
    ...
    public Team team { get { return (Team)GetComponent(GameComponentsLookup.Team); } }
    public bool hasTeam { get { return HasComponent(GameComponentsLookup.Team); } }

    public void AddTeam(Roguelite.Enums.Team newValue) {
        var index = GameComponentsLookup.Team;
        var component = (Team)CreateComponent(index, typeof(Team));
        component.value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceTeam(Roguelite.Enums.Team newValue) {
        var index = GameComponentsLookup.Team;
        var component = (Team)CreateComponent(index, typeof(Team));
        component.value = newValue;
