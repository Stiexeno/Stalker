...
public partial class GameEntity {
    ...
    public void AddAsset(string newValue, UnityEngine.Vector3 newPosition, UnityEngine.Transform newParent, bool newPrewarm) {
        ...
        component.prewarm = newPrewarm;
        AddComponent(index, component);
    }

    public void ReplaceAsset(string newValue, UnityEngine.Vector3 newPosition, UnityEngine.Transform newParent, bool newPrewarm) {
        var index = GameComponentsLookup.Asset;
        var component = (AssetComponent)CreateComponent(index, typeof(AssetComponent));
        component.value = newValue;
        component.position = newPosition;
